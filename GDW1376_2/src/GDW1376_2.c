...
#define CHANGE_LOG  \
        "-----------------------------------\n"\
        "2026年5月3日:M4 AFN05(F3长度/F6表44/F100场强/F101六字节BCD);AFN04(F1/F2/F3长度校验);F3首字段文案为通信速率\n"\
        "2026年5月3日:M3 AFN05-F200;AFN14-F4 上行表113/下行表117变长;AFN=F0H 厂家自定义数据域HEX转储\n"\
...
GDW1376_2_error(int errid)
{
    const char * const perror[] =
    {
        ...
        "不支持的FN",
        "应用数据LEN有误",
        "输入报文太长, 请检查是否存在多条Q/GDW10376.2报文粘包!",
    };
